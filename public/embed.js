/*1750431057,,JIT Construction: v1024028075,en_US*/
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              function I() {
                ...
                for (var e of c)
                  if (e != null) {
                    var f = e.length;
                    for (var g = 0; g < f; g++)
                      a = (a << 5) - a + e.charCodeAt(g);
                  }
                var h = "";
                for (var i = 0; i < 6; i++)
                  (h = ka.charAt(a & 31) + h), (a >>= 5);
                return h;
              }
              var la = [
                  /\(([^\s\)\()]+):(\d+):(\d+)\)$/,
              ...
              var ta = "<anonymous guard>",
                ...
                T = {
                  applyWithGuard: function (a, b, c, d) {
                    if (
                      m.config.skipDupErrorGuard &&
                      "__isMetaErrorGuarded" in a
                    )
                      return a.apply(b, c);
                    A.pushGuard({
                      name:
              ...
              function xa(a, b, c) {
                ...
                V.length < 15 &&
                  ES(["fatal", "error"], "includes", !0, a.type) &&
                  V.push(a.hash);
                c(d);
                return !0;
              }
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g, h) {
              ...
              function N(a) {
                ...
                return !a
                  ? null
                  : a[1].replace(/^https?:\/\/(www.)?/, "https://www.") + "/";
              }
              function O(a) {
              ...
              function T(a) {
                ...
                switch (a) {
                  case c("IGIframeableMessageTypes").MOUNTED:
                    ...
                    a || h(0, 4412, d);
                    g = a.clientHeight;
                    b.style.position = b.hasAttribute(B)
                      ? b.getAttribute(B)
                      : "";
  ...
  __fb_i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1024028075","namespace":"FB","message":"' +
        __fb_err.message +
        '"}}'
    );
